 ...
 * @e_ident: array containing elf classes
 */
 ...
 * @e_ident: array containing the data
 */
 ...
 * @e_type: type
 * @e_ident: array containing elf type
 */
...
/**
 * main - prints the information contained in the file
...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
	...
	rd = read(o, hdr, sizeof(Elf64_Ehdr));
	if (rd == -1)
	{
		free(hdr);
		close_elf(o);
